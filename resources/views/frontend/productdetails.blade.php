            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="product-single-img">
                        <div class="product-active owl-carousel">
                            <div class="item">
                                <img src="{{ asset('frontend_asset') }}/images/product/product-details/1.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('frontend_asset') }}/images/product/product-details/2.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('frontend_asset') }}/images/product/product-details/3.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('frontend_asset') }}/images/product/product-details/4.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('frontend_asset') }}/images/product/product-details/5.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('frontend_asset') }}/images/product/product-details/6.jpg" alt="">
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="product-single-content">
                        <h3>{{ $productdetails->product_name }}y</h3>
                                ...
                                <ul>
                                    <li class="review-items">
                                        <div class="review-img">
                                            <img src="{{ asset('frontend_asset') }}/images/comment/1.png" alt="">
                                        </div>
                                    ...
                                    <li class="review-items">
                                        <div class="review-img">
                                            <img src="{{ asset('frontend_asset') }}/images/comment/2.png" alt="">
                                        </div>
                                        <div class="review-content">
                                    ...
                                    <li class="review-items">
                                        <div class="review-img">
                                            <img src="{{ asset('frontend_asset') }}/images/comment/3.png" alt="">
                                        </div>
                                        <div class="review-content">
